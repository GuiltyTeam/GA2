...
public interface IChimpDevice {
     ...
     */
    void reboot(@Nullable String into) throws AdbCommandRejectedException, IOException, TimeoutException;
     ...
     */
    String shell(String cmd) throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException;
     ...
     * @return the output of the command
     */
    String shell(String cmd, int timeout) throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException;
    ...
    Map<String, Object> instrument(String packageName,
            Map<String, Object> args) throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException;
