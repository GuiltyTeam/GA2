...
public interface IChimpBackend {
     ...
     */
    IChimpDevice waitForConnection() throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException;
     ...
     * @return the connected device (or null if timeout);
     */
    IChimpDevice waitForConnection(long timeoutMs, String deviceIdRegex) throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException;
