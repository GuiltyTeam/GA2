...
public class AdbBackend implements IChimpBackend {
    ...
    @Override
    public IChimpDevice waitForConnection(long timeoutMs, String deviceIdRegex) throws TimeoutException, AdbCommandRejectedException, ShellCommandUnresponsiveException, IOException {
        do {
